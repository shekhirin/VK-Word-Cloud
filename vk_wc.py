...
def send_cloud(user_id, message):
    ...
    try:
        ...
        vk_group.messages.send(
            user_id=user_id,
            message='Кстати, у нас в группе скоро будет проходить розыгрыш. '
                    'На кону Ваше облако 2017 года в рамке, которую можно повесить на стену, не пропусти 🎁🎁🎁',
            attachment=['wall-136503501_466'] if
